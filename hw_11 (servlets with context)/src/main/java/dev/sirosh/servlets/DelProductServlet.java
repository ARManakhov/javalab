...
import dev.sirosh.services.DeleteProductService;
...
public class DelProductServlet extends HttpServlet {
    ...
    public void init(ServletConfig config) throws ServletException {
        ...
        deleteProductService = (DeleteProductService) servletContext.getAttribute("deleteProductService");
        super.init(config);
    }
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (req.getSession().getAttribute("token") != null) {
            ...
            deleteProductService.execute(DtoProductListBuilder.aDtoProductList().withId(productId).withToken(token).build());
            req.getRequestDispatcher("/").forward(req, resp);
        } else {
