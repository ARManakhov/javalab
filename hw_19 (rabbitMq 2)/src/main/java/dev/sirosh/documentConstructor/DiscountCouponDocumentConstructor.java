...
public class DiscountCouponDocumentConstructor implements DocumentConstructor {

    File folder;
    String srcPath = "pdf_templates/discountCoupon.pdf";

    public DiscountCouponDocumentConstructor(File distFolder){
        folder = distFolder;
        folder.mkdirs();
    }
    @Override
