...
public class DeductionDocumentConstructor implements DocumentConstructor {

    File folder;
    String srcPath = "pdf_templates/deduction.pdf";

    public DeductionDocumentConstructor(File distFolder){
        folder = distFolder;
        folder.mkdirs();
    }
    @Override
