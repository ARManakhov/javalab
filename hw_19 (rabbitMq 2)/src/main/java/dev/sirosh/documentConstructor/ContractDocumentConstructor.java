...
public class ContractDocumentConstructor implements DocumentConstructor {

    File folder;
    String srcPath = "pdf_templates/contract.pdf";

    public ContractDocumentConstructor(File distFolder){
        folder = distFolder;
        folder.mkdirs();
    }
    @Override
